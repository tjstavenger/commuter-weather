function loadNws() {
	...
	// remote CORS proxy
	$.when( $.getJSON('https://api.codetabs.com/v1/tmp/?quest=' + encodeURIComponent('https://mobile.weather.gov/wtf/MapClick.php?lat=' + options.location.lat + '&lon=' + options.location.lon + '&unit=0&lg=english&FcstType=json&rand=' + today.getTime())),
			$.getJSON('https://api.codetabs.com/v1/tmp/?quest=' + encodeURIComponent('https://mobile.weather.gov/wtf/MapClick.php?lat=' + options.location.lat + '&lon=' + options.location.lon + '&unit=0&lg=english&FcstType=digitalJSON&rand=' + today.getTime()))
